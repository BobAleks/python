# Задача-6: Реализовать структуру данных «Товары». Она должна представлять
...
control = None
while True:
    control = input("Для выхода нажмите 'Q', Для продолжения ввода нажмите 'Enter', Для вывода списка нажмите 'A'").upper()
    if control == 'Q':
        break
    num += 1
    if control == 'A':
    ...
    for f in features.keys():
        feature_ = input(f'Введите далее "{f}"')
